...
export default {
    ...
    theme: {
      extend: {
        ...
        fontSize: {
          display:   ['clamp(2.5rem, 1.5rem + 4.4vw, 4.5rem)', { lineHeight: '1.05', letterSpacing: '-0.03em' }],
          h2:        ['clamp(2rem, 1.45rem + 2.4vw, 3rem)', { lineHeight: '1.08', letterSpacing: '-0.02em' }],
          h3:        ['clamp(1.5rem, 1.25rem + 1.1vw, 1.875rem)', { lineHeight: '1.2', letterSpacing: '-0.015em' }],
