    ...
    <footer className="relative bg-[#0F0E1A] border-t border-white/10 text-white pt-20 pb-12 overflow-hidden">
      ...
      <div className="relative px-6 md:px-10 lg:px-14 max-w-7xl mx-auto">
        ...
        <div className="relative p-8 md:p-12 rounded-2xl border border-white/10 bg-white/[0.02] flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-16">
          <div className="max-w-xl">
            ...
            <h3 className="font-serif text-[28px] md:text-[36px] leading-tight">
              Tens um projeto em mente? <span className="italic text-white/50">Vamos tirá-lo do papel.</span>
            </h3>
            <p className="mt-2 text-[14px] text-white/60">
              Estou disponível para novos projetos de websites institucionais, landing pages e identidades de marca.
            </p>
          </div>

          <div>
            <a 
              href="mailto:ola@bybia.dev" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 border-b border-white/10 pb-16">
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            <a href="#" className="flex items-center gap-2 group w-max">
              <div className="w-8 h-8 flex items-center justify-center rounded-full overflow-hidden bg-[#534AB7] text-white">
            ...
            <p className="text-[13px] text-white/50 leading-relaxed max-w-xs">
              Desenvolvedora web independente a criar soluções sólidas e código à medida para o ecossistema digital português.
            </p>
          </div>
          ...
          <div className="md:col-span-3 flex flex-col gap-4">
            <h4 className="text-[11px] font-mono tracking-wider text-white/40 uppercase">Contacto</h4>
            <ul className="flex flex-col gap-2.5 text-[13px]">
              <li>
                <a href="mailto:ola@bybia.dev" className="text-white/70 hover:text-[#02C39A] transition-colors flex items-center gap-2">
                  <i className="ri-mail-line text-neutral-500"></i> ola@bybia.dev
                </a>
              </li>
              <li>
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#02C39A] transition-colors flex items-center gap-2">
                  <i className="ri-github-line text-neutral-500"></i> GitHub
                </a>
              </li>
              <li>
                <span className="text-white/70 flex items-center gap-2">
                  <i className="ri-map-pin-line text-neutral-500"></i> Portugal
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] font-mono text-white/40">
          <div>
            © {new Date().getFullYear()} ByBia.dev. Todos os direitos reservados.
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#02C39A]"></span>
            <span>Feito com código limpo</span>
          </div>
        </div>
